...
//     useEffect(() => {
//         if (selectedOption === "dataAnggota") {
//             // Panggil API atau fetch data dari server untuk data anggota
//             fetch("http://localhost:3060/api/data-anggota")
//                 .then((response) => response.json())
//                 .then((data) => setData(data))
//                 .catch((error) => console.error("Error fetching data:", error));
//         } else if (selectedOption === "presensi") {
//             // Panggil API atau fetch data dari server untuk presensi
//             // Pastikan Anda mengganti URL fetch dengan URL yang benar
//             fetch("http://localhost:3060/api/data-anggota")
//                 .then((response) => response.json())
//                 .then((data) => setPresensiAnggota(data))
...
//             setButtonClicked(false); // Set buttonClicked kembali ke false saat opsi dipilih kembali
//         }
//     };
...
//             {buttonClicked && selectedOption === "dataAnggota" ? (
//                 <div className='mx-auto gap-8 mt-12'>
//                     <MembersTable data={data} setData={setData} />
//                 </div>
//             ) : null}

//             {buttonClicked && selectedOption === "presensi" ? (
//                 <div className='mx-auto gap-8 mt-12'>
//                     <TabelPresensi presensi={presensiAnggota} setPresensi={setPresensiAnggota} />
//                 </div>
//             ) : null}
//         </div>
//     );
...
//     return (
//         <div className="w-72">
//             <Select label="Opsi" value={selectedOption} onChange={onSelectChange}>
//                 <Option value="presensi">Presensi Anggota</Option>
...
//                 .catch((error) => console.error("Error fetching data anggota:", error));
//         } else {
//             console.log("Data anggota belum diambil.");
//         }
//     }, [buttonClicked, selectedOption]);

//     const handleSelectChange = (e) => {
//         console.log(e); // Periksa event di konsol browser
//         setSelectedOption(e.target.value);
//     };
...
//     return (
//         <div className="w-72">
//             <Select label="Opsi" value={selectedOption} onChange={(e) => onSelectChange(e.target.value)}>
//                 <Option value="presensi">Presensi Anggota</Option>
//                 <Option value="dataAnggota">Data Anggota</Option>
//             </Select>
//         </div>
